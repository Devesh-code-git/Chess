...
When a king gets checked, it will be highlighted by a muted red color
-
- 
![](images/ChessCheckmateHighlight.png)
When a king gets checkmated, it will be highlighted by a strong red color instead, and also mouse input will be disabled
- 
- 
